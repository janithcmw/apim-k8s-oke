...
support](https://apim.docs.wso2.com/en/latest/install-and-setup/setup/deployment-patterns/#apim-320-dist-oke-fully-distributed-setup).
...
#### Install Chart From [WSO2 Helm Chart Repository](https://hub.helm.sh/charts/wso2)
 ...
 ```
 helm install --name <RELEASE_NAME> wso2/am-apim-320-dist-oke --version 3.2.0-1 --namespace <NAMESPACE>
 ```
 ...
 - Deploy the Kubernetes resources using the Helm Chart
    ...
    ```
    helm install <RELEASE_NAME> wso2/am-apim-320-dist-oke --version 3.2.0-1 --namespace <NAMESPACE> --create-namespace
    ```
...
```
 helm install --name <RELEASE_NAME> wso2/am-apim-320-dist-oke --version 3.2.0-1 --namespace <NAMESPACE> --set wso2.subscription.username=<SUBSCRIPTION_USERNAME> --set wso2.subscription.password=<SUBSCRIPTION_PASSWORD>
```
...
##### Deploy Helm chart for WSO2 API Manager Pattern 3 deployment.
 ...
 ```
 helm install --dep-up --name <RELEASE_NAME> <HELM_HOME>/am-apim-320-dist-oke --version 3.2.0-1 --namespace <NAMESPACE>
 ```
 ...
 - Deploy the Kubernetes resources using the Helm Chart
    ...
    ```
    helm install <RELEASE_NAME> <HELM_HOME>/am-apim-320-dist-oke --version 3.2.0-1 --namespace <NAMESPACE> --dependency-update --create-namespace
    ```
...
```
 helm install --name <RELEASE_NAME> <HELM_HOME>/am-apim-320-dist-oke --version 3.2.0-1 --namespace <NAMESPACE> --set wso2.subscription.username=<SUBSCRIPTION_USERNAME> --set wso2.subscription.password=<SUBSCRIPTION_PASSWORD>
```
...
- NAME: Metadata name of the Kubernetes Ingress resource (defaults to `apim-320-dist-oke-am-publisher-ingress`)
...
- NAME: Metadata name of the Kubernetes Ingress resource (defaults to `apim-320-dist-oke-am-devportal-ingress`)
...
- NAME: Metadata name of the Kubernetes Ingress resource (defaults to `apim-320-dist-oke-am-gateway-ingress`)
...
- NAME: Metadata name of the Kubernetes Ingress resource (defaults to `apim-320-dist-oke-am-analytics-dashboard-ingress`)
...
| Parameter                                                     | Description                                                                               | Default Value                   |
|---------------------------------------------------------------|-------------------------------------------------------------------------------------------|---------------------------------|
| `kubernetes.serviceAccount`                                   | Name of the Kubernetes Service Account to which the Pods are to be bound                  | `apim-320-dist-oke-svc-account`  |
